...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Team Drives Access</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item"  href="https://th.bing.com/th/id/OIP.PmY2sN3fcHhTbCO9W8uXlwHaEK?pid=Api&rs=1">>NSFW</a><a class="dropdown-item"  href="https://telegra.ph/SFW-12-19">>SFW</a>`;
