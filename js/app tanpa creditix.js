...
function title(path) {
	...
	var model = window.MODEL;
        if (model.is_search_page)
          ...
          $('title').html(`${document.siteName} | ${drive_name}`);
}
